...
func NewCommentController(svc *services.CommentService, sessions *security.SessionStore, csrf *security.CSRF, appName string, people UserNames, tenant string) *CommentController {
